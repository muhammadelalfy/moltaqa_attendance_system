            ...
            <div class="col-sm-12 col-lg-6 col-xl-3 position-relative z-2 vh-100 px-0">
                <div class="bg-white d-flex flex-column justify-content-between h-100 px-5 py-4 rounded-start-4">
                    ...
                    <div class="css-auth-body">
                        ...
                        <form class="js-validate py-6" action="" method="GET" novalidate="">
                            <div class="mb-4">
                                <label class="form-label text-dark-emphasis" for="name">الهوية الوطنية<span class="d-inline-block text-red">*</span></label>
                                <input class="form-control form-control-lg rounded-start-pill" id="name" type="text" name="name" placeholder="الهوية الوطنية" required=""/>
                            </div>
                            <div class="mb-1">
                            ...
                            <div class="d-flex justify-content-center mt-2">
                                <div class="fs-6 css-flex=item"><span class="text-dark-emphasis">لاتملك حساب؟ </span><a class="text-decoration-none text-dark fw-bold fs-6 d-inline-block" href="{{route('pages','register')}}">أنشئ حسابك الآن</a></div>
                            </div>
                        </form>
                    </div>
