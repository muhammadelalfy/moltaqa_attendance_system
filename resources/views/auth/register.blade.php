    ...
    <div class="position-relative z-3 start-0 w-100 css-box-over-header">
        ...
        <div class="container">
            <div class="bg-white rounded-3 p-5 border">
                ...
                <div class="pb-4">
                    <figcaption class="text-dark italic">جميع الحقول مطلوبة<span
                ...
                <div class="col-lg-12">
                    <form class="mt-4 js-validate" action="{{route('register')}}" method="POST" novalidate="">
                        @csrf
                        <div class="mb-4">
                            <label class="form-label text-dark-emphasis" for="name">الاسم الرباعي<span
                                    class="d-inline-block text-red">*</span></label>
                            <input class="form-control" id="name" type="text" name="name" placeholder="الاسم الرباعي"
                                   required="" autofocus=""/>
                            @if($errors->has('name'))
                        ...
                        <div class="mb-4">
                            <label class="form-label text-dark-emphasis" for="id">الهوية الوطنية<span
                                    class="d-inline-block text-red">*</span></label>
                            <input class="form-control" id="id" type="text" name="identity" placeholder="الهوية الوطنية"
                                   required=""/>
                        ...
                        <div class="mb-4">
                            <label class="form-label text-dark-emphasis" for="address">الجنس<span
                                    class="d-inline-block text-red">*</span></label>
                        ...
                        <div class="mb-4">
                            <label class="form-label text-dark-emphasis" for="email">البريد الالكتروني<span
                                    class="d-inline-block text-red">*</span></label>
                        ...
                        <div class="mb-4">
                            <label class="form-label text-dark-emphasis" for="password">كلمة المرور<span
                                    class="d-inline-block text-red">*</span></label>
                        ...
                        <div class="mb-4">
                            <label class="form-label text-dark-emphasis" for="confirmpassword">تأكيد كلمة المرور<span
                                    class="d-inline-block text-red">*</span></label>
                            <div class="css-input-password">
